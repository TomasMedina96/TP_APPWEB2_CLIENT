export const showNotification = (id, message) => {
    ...
    if (!notification) {
        ...
        notification.className = 'notification bg-yellow-300 text-black border border-yellow-600 px-4 py-2 rounded mt-2 flex items-center animate__animated animate__fadeIn';
